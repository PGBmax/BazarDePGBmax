...
function saveState() {
  ...
  localStorage.setItem("tierListData_LegVoid", JSON.stringify(state));
}

function loadState() {
  const raw = localStorage.getItem("tierListData_LegVoid");
...
function resetTierList() {
  ...
  localStorage.removeItem("tierListData_LegVoid");
  tierList.innerHTML = "";
  unranked.innerHTML = "";
  loadInitialImages();
