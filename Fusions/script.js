...
function saveState() {
  ...
  localStorage.setItem("tierListData_Fusions", JSON.stringify(state));
}

function loadState() {
  const raw = localStorage.getItem("tierListData_Fusions");
...
function resetTierList() {
  ...
  localStorage.removeItem("tierListData_Fusions");
  tierList.innerHTML = "";
  unranked.innerHTML = "";
  loadInitialImages();
