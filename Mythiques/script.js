...
function saveState() {
  ...
  localStorage.setItem("tierListData_Mythiques", JSON.stringify(state));
}

function loadState() {
  const raw = localStorage.getItem("tierListData_Mythiques");
...
function resetTierList() {
  ...
  localStorage.removeItem("tierListData_Mythiques");
  tierList.innerHTML = "";
  unranked.innerHTML = "";
  loadInitialImages();
