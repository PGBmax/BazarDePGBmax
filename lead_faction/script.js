...
function saveState() {
  ...
  localStorage.setItem("tierListData_LeadFaction", JSON.stringify(state));
}

function loadState() {
  const raw = localStorage.getItem("tierListData_LeadFaction");
...
function resetTierList() {
  ...
  localStorage.removeItem("tierListData_LeadFaction");
  tierList.innerHTML = "";
  unranked.innerHTML = "";
  loadInitialImages();
